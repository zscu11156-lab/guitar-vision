...
import 'lesson2_4.dart';
import 'flip_page_route.dart';
import 'tuner.dart';
import 'chordchart.dart';
import 'member.dart';

class Lesson2Page3 extends StatelessWidget {
  const Lesson2Page3({super.key});
            ...
            Positioned(
              ...
              child: IconButton(
                ...
                onPressed: () {
                  Navigator.pushReplacement(
                    context,
                    FlipPageRoute(child: const Lesson2Page4()),
                  );
                },
              ),
            ),
