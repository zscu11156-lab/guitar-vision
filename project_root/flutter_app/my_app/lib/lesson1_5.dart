...
import 'lesson1_4.dart'; // 回上一頁用
import 'flip_page_route.dart';
import 'tuner.dart';
import 'chordchart.dart';
import 'member.dart';
import 'lesson1test.dart';

class Lesson1Page5 extends StatelessWidget {
  const Lesson1Page5({super.key});
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: const [
                          ...
                          SizedBox(height: 12),
                          _BulletText('X＝悶音　—＝空掃　↑＝上撥　↓＝下撥'),
                          SizedBox(height: 6),
                          _BulletText('每型 4 小節循環'),
                        ],
                      ),
                    ),
                  ),
              ...
              child: OutlinedButton(
                ...
                onPressed: () {
                  Navigator.of(context).push(
                    FlipPageRoute(child: const Lesson1TestPage()),
                  );
                },
                child: const Text(
                  'test',
